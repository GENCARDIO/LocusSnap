...
TSV_FIELDS = [
    ...
    "molecule_tag",
    "molecule_id",
    "molecule_family_size",
    "molecule_duplicate_reads",
    "molecule_is_duplex",
    "molecule_consensus_fraction",
    "mate_chrom",
    "is_secondary",
    "is_supplementary",
    "is_duplicate",
...
def read_to_row(read: AlignedRead) -> dict:
    return {
        ...
        "tag_value": read.tag_value,
        "molecule_tag": getattr(read, "molecule_tag", None),
        "molecule_id": getattr(read, "molecule_id", None),
        "molecule_family_size": getattr(read, "molecule_family_size", 1),
        "molecule_duplicate_reads": getattr(read, "molecule_duplicate_reads", 0),
        "molecule_is_duplex": getattr(read, "molecule_is_duplex", False),
        "molecule_consensus_fraction": getattr(
            read, "molecule_consensus_fraction", 1.0
        ),
